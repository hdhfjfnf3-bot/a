      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        ...
        <div className="glass-panel p-8 md:p-12 rounded-2xl space-y-8 text-muted-foreground leading-relaxed text-lg">
          ...
          <section>
            ...
            <p className="mb-4">
              تخضع عمليات الاسترجاع والاستبدال للسياسة الشاملة المنشورة بصفحة "سياسة الاسترجاع". بشكل عام وفي إطار الحزم لضمان جودة المنتجات: لا يُقبل نهائياً الاسترجاع لمجرد تغيير الرأي أو عدم الرغبة. الاسترجاع أو الاستبدال متاح <span className="font-bold text-primary">فقط</span> في حال وجود عيب صناعة، ويُشترط الإبلاغ وتقديم صور واضحة تثبت العيب خلال <span className="font-bold text-red-500">48 ساعة</span> كحد أقصى من الاستلام.
            </p>
          </section>
