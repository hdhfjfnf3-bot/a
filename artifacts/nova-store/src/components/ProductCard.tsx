  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative flex flex-col bg-card rounded-2xl border border-white/5 overflow-hidden shadow-xl hover:shadow-primary/20 transition-shadow duration-500 h-full"
      >
        {/* Badges */}
        ...
        {/* Image Container */}
        <div className="relative aspect-[4/5] overflow-hidden bg-white/5 p-4 flex items-center justify-center">
          <motion.img
          ...
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
            <Button 
              size="lg" 
              className="gap-2 scale-90 group-hover:scale-100 transition-transform duration-300"
              onClick={(e) => {
                e.stopPropagation();
        ...
        <div className="p-5 flex flex-col flex-grow">
          <Link href={`/products/${product.id}`} className="block mt-auto">
            <h3 className="text-lg font-bold text-foreground line-clamp-2 hover:text-primary transition-colors mb-2">
          ...
          <div className="flex items-end justify-between mt-4">
            ...
            <p className="text-xs text-muted-foreground font-medium bg-white/5 px-2 py-1 rounded">
